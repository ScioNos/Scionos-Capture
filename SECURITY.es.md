...
La última release publicada recibe correcciones de seguridad; la línea compatible actual es `1.0.x`.
...
Las capturas, incluidos los mosaicos de un área desplazable, permanecen en el origen local. No se ejecutan scripts remotos y el nuevo modo no añade permisos. Las huérfanas caducan tras una hora. Usa máscara sólida para secretos; el desenfoque no es una eliminación criptográfica.
