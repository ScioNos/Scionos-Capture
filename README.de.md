...
`scionos-capture-v1.3.0.zip` aus dem [Release v1.3.0](https://github.com/ScioNos/Scionos-Capture/releases/tag/v1.3.0) herunterladen, optional `.sha256` prüfen und entpacken. `chrome://extensions` oder `edge://extensions` öffnen, **Entwicklermodus** aktivieren, **Entpackte Erweiterung laden** wählen und den Ordner auswählen.
